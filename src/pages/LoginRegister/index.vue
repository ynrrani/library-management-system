...
export default {
  ...
  methods: {
    sendRegisterMsg() {
      ...
      register(qs.stringify(data)).then(
        (res) => {
          console.log(res);
          if (res.status == 200) {
...
.container {
  ...
  box-shadow: 0 0.9rem 1.7rem rgba(122, 7, 7, 0.25),
    0 0.7rem 0.7rem rgba(116, 4, 4, 0.22);
  height: 420px;
  max-width: 758px;
  overflow: hidden;
  position: relative;
...
.overlay {
  background-color: rgba(189, 124, 105, 0.703);
  background-attachment: fixed;
  background-position: center;
  background-repeat: no-repeat;
  background-size: cover;
